...
class _AssignmentsScreenState extends State<AssignmentsScreen> {
  ...
  void _applyFilters() {
    setState(() {
      ...
      if (_selectedFilter != 'All') {
        filtered = filtered
            .where((assignment) => assignment.status.toLowerCase() == _selectedFilter.toLowerCase())
            .toList();
      }
      ...
      print('✅ Filtered assignments: ${_filteredAssignments.length}');
    });
  }
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // Quick Actions for pending assignments - FIXED
                if (assignment.status == 'pending')
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Expanded(
                        child: _buildQuickActionFixed(
                          'Remind',
  ...
  Widget _buildQuickActionFixed(String label, IconData icon, VoidCallback onTap, {bool isPrimary = false}) {
  ...
  void _showSubmissionDialog(Assignment assignment) {
    final TextEditingController submissionNotesController = TextEditingController();
        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 16),
              TextField(
                controller: submissionNotesController,
                maxLines: 4,
                decoration: InputDecoration(
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'You can attach files after submission',
                        style: TextStyle(
                          fontSize: 12,
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              try {
                ...
                await _firestoreService.submitAssignment(
                  assignment.id,
                  submissionNotesController.text,
                );
